                    ...
                    for aux_loss_activated in [True]:
                        for opt in [2]:
                            for t in range(30):
                                ...
                                try:
                                    data_prior = ut.generate_samples(samples, train_dataset, epsilon,  option = opt,  DRs={'feature':'Amplitude', 'up': 0.6, 'lp': 0.2})
                                    ...
                                    pd.DataFrame(results, columns=['acc_train', 'acc_test','recall_train', 'recall_test','f1_train', 'f1_test', 
                                     ...
                                     'aux_loss_activated', 'EPS1', 'n', 'opt']).to_csv('05-06-2022-sc-1D-amplitude-RRLyrae.csv')
